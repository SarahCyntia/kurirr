...
const columns = [
  ...
  column.accessor("pengirim", { header: "Pengirim" }), // baru
  column.accessor("kurir_id", { header: "Kurir" }), // bisa diganti jadi nama kurir via relasi nanti
  column.accessor("penelian", { header: "Penilaian" }), // baru
