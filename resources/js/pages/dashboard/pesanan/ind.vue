...
const searchQuery = ref<string>(""); // Pencarian pesanan
...
const updateOrderStatus = async (uuid: string, newStatus: string) => {
  ...
  if (result.isConfirmed) {
    updateStatus(`/pesanan/${uuid}`, { status: newStatus });
  }
};
  ...
  column.accessor("uuid", {
    ...
    cell: (cell) =>
      h("div", { class: "d-flex gap-2" }, [
        ...
        //     onClick: () => deletePesanan(`/pesanan/${cell.getValue()}`),
        //   },
...
<template>
  ...
  <div class="card">
      ...
      <div class="row g-2">
        <div class="col-md-6">
          <input
            ...
            type="text"
            class="form-control"
            placeholder="Cari pesanan berdasarkan nama atau produk..."
    ...
    <div class="card-body">
      <paginate ref="paginateRef" id="table-pesanan" url="pesanan" :columns="columns"></paginate>
    </div>
  </div>
</template>
